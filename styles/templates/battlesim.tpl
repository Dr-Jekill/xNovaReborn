...
<td>
 <center><img src="styles/theme/{$Raza_skin}/images/crystal.jpg" class="tooltip" name="{$Crystal}" /> <br /> <input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.2}{$battleinput.0.1.2}{else}0{/if}" name="battleinput[0][1][2]"></center>
 </td>
 
 <td>
 <center><img src="styles/theme/{$Raza_skin}/images/deuterium.jpg" class="tooltip" name="{$Deuterium}" /> <br />  <input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.3}{$battleinput.0.1.3}{else}0{/if}" name="battleinput[0][1][3]"></center>
 </td>
