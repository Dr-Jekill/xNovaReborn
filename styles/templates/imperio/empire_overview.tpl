...
<br />
 	<table id="imperio_tabla" style="text-align: center;">        
            ...
            <tr>
				<td><img class="tooltip" name="<font color='#6eb6ff'><b><h3>{$Crystal}</h3></b></font>" src="styles/theme/{$Raza_skin}/images/crystal.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
            ...
            <tr>
				<td><img class="tooltip" name="<font color='#1a8494'><b><h3>{$Deuterium}</h3></b></font>" src="styles/theme/{$Raza_skin}/images/deuterium.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
