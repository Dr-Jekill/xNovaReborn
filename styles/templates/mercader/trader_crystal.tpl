			...
			<tbody><tr>
				...
				<tr class="alt_2">
					...
					<td class="noCenter">{$Metal}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color"  data-role="PGtooltip" data-direction="top" data-content="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Crystal}</b></span> = {$mod_ma_res_a} {$Metal}">{$mod_ma_res_a}</span>
						</td>
				</tr>
				<!-- Cristal -->
				<tr class="alt">
    				...
    				<td class="marca_color" id="crystal">&nbsp;</td>
						<td class="rate"><span data-role="PGtooltip" data-direction="top" data-content="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Crystal}</b></span> = {$mod_ma_res_a} {$Metal}, {$mod_ma_res_b} {$Deuterium}, {$mod_ma_res_d} {$Norio}">1</span></td>
				...
				<tr class="alt_2">
					...
					<td class="noCenter">{$Deuterium}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color"  data-role="PGtooltip" data-direction="top" data-content="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Crystal}</b></span> = {$mod_ma_res_b} {$Deuterium}">{$mod_ma_res_b}</span>
						</td>
				</tr>
				<!-- Norio -->
				<tr class="alt_2">
					...
					<td class="noCenter">{$Norio}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color" data-role="PGtooltip" data-direction="top" data-content="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Crystal}</b></span> = {$mod_ma_res_d} {$Norio}">{$mod_ma_res_d}</span>
						</td>
				</tr>
				<!-- Otras cosas -->
				<tr>
