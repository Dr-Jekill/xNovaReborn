...
<div id="planeta_small" style="background-image: url(styles/theme/{$Raza_skin}/adds/flotas2.jpg);">
    <div id="titular_texto_cabez" style="display: block;">{$fl_send_fleet}</div>
</div>
		...
		<table class="datos_vuelo" >
		   <tr>
            	<td>
                    ...
                    <input type="text" class="campo_comun" name="galaxy" size="3" maxlength="2" onChange="updateVars()" onKeyUp="updateVars()" value="{$galaxy_post}">
                    <input type="text" class="campo_comun" name="system" size="3" maxlength="3" onChange="updateVars()" onKeyUp="updateVars()" value="{$system_post}">
                    <input type="text" class="campo_comun" name="planet" size="3" maxlength="2" onChange="updateVars()" onKeyUp="updateVars()" value="{$planet_post}">
                    <select class="select" name="planettype" onChange="updateVars()" onKeyUp="updateVars()">
                    {html_options options=$options_selector selected=$options}
                    </select>
					<select class="select" name="speed" onChange="updateVars()" onKeyUp="updateVars()">
            ...
            <tr class="distancia">
            	<td style="height:50px;"><font color="#2b0000"><h4 style="cursor:help;" data-role="PGtooltip" data-direction="top" data-content="{$fl_distance}" id="distance">0</h4></font></td>
            </tr>
			<tr>
