...
<table width="40%">
<tr><th colspan="2"><h3>{$re_player_and_planets}</h3></th></tr>
...
<tr><th colspan="2"><h3>{$re_defenses_and_ships}</h3></th></tr>
...
<tr><th colspan="2"><h3>{$re_buldings}</h3></th></tr>
...
<tr><th colspan="2"><h3>{$re_investigations}</h3></th></tr>
...
<tr><th colspan="2"><h3>{$re_resources}</h3></th></tr>
...
<tr><th colspan="2"><h3>{$re_general}</h3></th></tr>
...
<tr><th style="text-align:left;"><h3>{$re_reset_all}</h3></th><th style="text-align:right;margin-right:2px;padding-right:5px;width:10px;"><input type="checkbox" name="resetall" onclick="$('input').attr('checked', 'checked');"></th></tr>
