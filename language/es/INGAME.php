...
$LNG['ov_free_inves']						= 'No se está investigando nada en el imperio.';
...
$LNG['ov_planets_act']						= 'Mis Planetas';
$LNG['ov_planets_edif']						= 'Edificios';
$LNG['ov_planets_inv']						= 'Investigacion';
$LNG['ov_planets_han']						= 'Hangar';
...
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/images/rangos/%s.png" /></center><br /><b>Es necesario ser almenos nivel %s para poder crear una alianza.<br /> Para llegar al nivel %s es necesario tener más de %s puntos</b> y para poder fundar la alianza es necesario %s puntos.';
...
$LNG['cdg_fatal_error']					= 'ERROR FATAL, por favor, espere a que la Administración se de cuenta de lo sucedido y repare el problema.<br>Atentamente, el sistema de xNova Reborn.';
...
$LNG['bd_upgradin']							= 'Subiendo al <br><span class="level">Nivel <j id="bLevel"></j></span>';
$LNG['rs_recursos']							= 'Recursos';
