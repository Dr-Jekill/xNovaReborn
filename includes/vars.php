...
if ( defined('INSIDE'))
{
	...
	$reslist['allow']    = array ( 1 => array(1,  2,  3, 7, 4, 6, 12, 14, 15, 21, 22, 23, 24, 25, 31, 33, 34,  44), 3 => array(12, 14, 21, 22, 23, 24, 25, 34, 41, 42, 43)); //falta el 36 => Astillero Orbital en el array 1
	$reslist['build']    = array (1, 2, 3, 7, 4, 6, 12, 14, 15, 21, 22, 23, 24, 25, 31, 33, 34, 44, 41, 42, 43); //falta el 36 => Astillero Orbital
	...
	$reslist['resources']  	= array (   1,   2,   3,  7,   4,   12, 22, 23, 24, 25, 212 );
}
?>