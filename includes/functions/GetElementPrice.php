...
function GetElementPrice ($USER, $PLANET, $Element, $USERfactor = true, $level = false)
	{
		...
		foreach ($array as $ResType => $ResTitle) {
         	...
         	if ($pricelist[$Element][$ResType] != 0) {
       			$text .= "<img style=\"padding-left:2px;padding-bottom:1px;padding-top:2px;float:left;\" src=styles/theme/" .$skin_raza ."/images/" .$ResType .".jpg data-role=\"PGtooltip\" data-direction=\"top\" data-content=\"" .$ResTitle .": " .$coste ."\" width=\"30\" height=\"20\" />";					
         	} 
     	}
	$text .= "";
    return $text; 
