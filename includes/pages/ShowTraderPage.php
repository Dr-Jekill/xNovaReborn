      ...
      switch ($ress) {
         case 'metal':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($crystal / 0.8 + $deut / 0.5 + $norio / 0.2);
         ...
         case 'crystal':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($metal / 1.25 + $deut / 0.625 + $norio / 0.25);                  
                  $PlanetRess->CalcResource();
         ...
         case 'deuterium':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($metal / 2 + $crystal / 1.6 + $norio / 0.5);   #si norio se multplica por (1) da el mismo resultado               
                  $PlanetRess->CalcResource();
         ...
         case 'norio':
            if($action == "trade")
            {
               ...
               {
                  $trade = ($metal / 5 + $crystal / 4 + $deut / 2);         
                  $PlanetRess->CalcResource();
