...
class MissionCaseSpy extends MissionFunctions
{
	...
	private function SpyTarget($TargetPlanet, $Mode, $TitleString, $LNG)
	{
		...
		if ($Mode == 0)
		{
                ...
                <td style="width:25%;" class="left transparent"><img src="styles/theme/' . $skin_raza .'/images/crystal.jpg" class="tooltip" name="'. $LNG['Crystal']   .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['crystal'])    .'</td>
                </tr><tr>
                <td style="width:25%;" class="left transparent"><img src="styles/theme/' . $skin_raza .'/images/deuterium.jpg" class="tooltip" name="'. $LNG['Deuterium'] .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['deuterium'])  .'</td><td class="transparent">&nbsp;</td>
